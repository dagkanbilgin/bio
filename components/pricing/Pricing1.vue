<template>
  <div
    class="rn-pricing-area rn-section-gap section-separator scrollSpysection"
    id="pricing"
  >
    <div class="container">
      <div class="row">
                ...
                <div class="rn-pricing">
                  ...
                  <div class="pricing-body">
                    ...
                    <div class="check-wrapper">
                      <div class="left-area">
                        <div
                          v-for="(elm, i) in featuresStatic.slice(0, 6)"
                          :key="i"
                          class="check d-flex"
                        >
                      ...
                      <div class="right-area">
                        <div
                          v-for="(elm, i) in featuresStatic.slice(6)"
                          :key="i"
                          class="check d-flex"
                        >
                          <i data-feather="check"></i>
                ...
                <div class="rn-pricing">
                  ...
                  <div class="pricing-body">
                    ...
                    <div class="check-wrapper">
                      <div class="left-area">
                        <div
                          v-for="(elm, i) in featuresStandard.slice(0, 6)"
                          :key="i"
                          class="check d-flex"
                        >
                          <i data-feather="check"></i>
                      ...
                      <div class="right-area">
                        <div
                          v-for="(elm, i) in featuresStandard.slice(6)"
                          :key="i"
                          class="check d-flex"
                        >
                          <i data-feather="check"></i>
                ...
                <div class="rn-pricing">
                  ...
                  <div class="pricing-body">
                    ...
                    <div class="check-wrapper">
                      <div class="left-area">
                        <div
                          v-for="(elm, i) in featuresPremium.slice(0, 6)"
                          :key="i"
                          class="check d-flex"
                        >
                          <i data-feather="check"></i>
                      ...
                      <div class="right-area">
                        <div
                          v-for="(elm, i) in featuresPremium.slice(6)"
                          :key="i"
                          class="check d-flex"
                        >
                          <i data-feather="check"></i>
